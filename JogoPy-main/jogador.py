...
class Jogador(pygame.sprite.Sprite):
    def __init__(self, pos, image, groups, collision_sprites, semi_collision_sprites, right_key, left_key, down_key, jump_key, outro_jogador=None):
        ...
        self.timers = {"wall jump": Timer(15), "wall climb": Timer(100), "plataforma fall": Timer(250), "bandeira": Timer(250)}
    ...
    def bandeira_touch(self):
        if self.timers["bandeira"]:
         #   print("bandeira")
            pass
    ...
    def check_contact(self):
        ...
        for sprite in [sprite for sprite in sprites if hasattr(sprite, "num_nivel")]:
            if sprite.rect.colliderect(chao_rect):
                self.bandeira = True
